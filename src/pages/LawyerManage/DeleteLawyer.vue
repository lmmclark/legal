<template>
	<div id="DeleteLawyer" class="mywrap_deleteLawyer">
	        ...
	        <Layout>
	        	<Content>
	                ...
	                <div class="wrap_item">
						...
						<div class="form_item">
							<div>
								<Form ref="deleteform" label-position="right" :label-width="125">
									<Row>
										<Col span="10">
									...
									<Row>
									    <Col span="24">
											<Form-item prop="description" label='出库描述'>
							...
							<div style="text-align: center;margin-top: 20px;">
								<Button type="primary" class="blue" @click="deleteLawer('deleteform')">确认申请出库</Button>
	...
	export default {
		...
		data(){
			return {
				path:[
					{'name':'律师库管理','path':''},
					{'name':'律师出库','path':'/main/lawyerManage/deleteLawyer'},
				],
				totalSize:1,
				currentPage:1,
				...
				columns: [
					...
					},
					{
						...
						render:(h, params) => {
                        	...
                        	if(params.row.areasExpertiseId == 1){
                        		return h('div', [
									h('span', {
										props: {
											type: 'primary',
                        	...
                        	}else if(params.row.areasExpertiseId == 2){
                        		return h('span', [
									h('span', {
										props: {
											type: 'primary',
                        	...
                        	}else if(params.row.areasExpertiseId == 3){
                        		return h('span', [
									h('span', {
										props: {
											type: 'primary',
		...
		mounted (){
			...
			this.baseInfo.reqApplicantName=eval('(' + userInfo + ')').org.orgName
